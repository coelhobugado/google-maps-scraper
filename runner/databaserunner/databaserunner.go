...
import (
	...
	"github.com/coelhobugado/google-maps-scraper/postgres"
...
type dbrunner struct {
	cfg      *runner.Config
	provider postgres.LifecycleProvider
	produce  bool
...
func New(cfg *runner.Config) (runner.Runner, error) {
	...
	psqlWriter := postgres.NewResultWriterWithLifecycle(conn, ans.provider)

	writers := []scrapemate.ResultWriter{
		runner.NewDriftDetectorWriter(psqlWriter),
	}
